...
def main():
    ...
    category_urls = {
        # "아우터": "https://www.musinsa.com/category/100006?gf=A", # 숏패딩/헤비 아우터
        "상의": "https://www.musinsa.com/category/001006?gf=A",
        # "바지": "https://www.musinsa.com/category/003002?gf=A",
        # "원피스_스커트": "https://www.musinsa.com/category/100001?gf=A",
    }
    ...
    # (아우터 폴더를 미리 생성)
    file_path = os.path.join("상의", "니트_스웨터.json")
